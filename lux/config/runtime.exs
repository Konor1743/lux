...
if config_env() in [:dev, :test] do
  config :lux, :api_keys,
    ...
    telegram_bot: env!("TELEGRAM_BOT_TOKEN", :string, nil),
    ...
    integration_telegram_bot: env!("INTEGRATION_TELEGRAM_BOT_TOKEN", :string, nil),
    allora: env!("ALLORA_API_KEY", :string!, "UP-8cbc632a67a84ac1b4078661"),
    youtube_client_id: env!("YOUTUBE_CLIENT_ID", :string, nil),
    youtube_client_secret: env!("YOUTUBE_CLIENT_SECRET", :string, nil),
    youtube_redirect_uri: env!("YOUTUBE_REDIRECT_URI", :string!, "http://localhost:4000/oauth/callback"),
    youtube_api_key: env!("YOUTUBE_API_KEY", :string, nil),
    youtube_access_token: env!("YOUTUBE_ACCESS_TOKEN", :string, nil),
    youtube_refresh_token: env!("YOUTUBE_REFRESH_TOKEN", :string, nil),
    integration_youtube_client_id: env!("INTEGRATION_YOUTUBE_CLIENT_ID", :string, nil),
    integration_youtube_client_secret: env!("INTEGRATION_YOUTUBE_CLIENT_SECRET", :string, nil),
    integration_youtube_refresh_token: env!("INTEGRATION_YOUTUBE_REFRESH_TOKEN", :string, nil),
    integration_youtube_api_key: env!("INTEGRATION_YOUTUBE_API_KEY", :string, nil)
